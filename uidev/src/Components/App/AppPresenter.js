...
import { Card, Key, KeyName, Title, Notification, Button } from "Components/Shared";
...
const AppPresenter = ({ isLoading, address = "", balance = "", mineBlock, isMining }) => (
  <AppContainer>
    <Header>
      <Title>{isLoading ? "Loading..." : "Dkimcoin Wallet"}</Title>
    ...
    <Card>
      ...
      <Key>
        <KeyName>Your balance:</KeyName> {balance} DKC
      </Key>
    </Card>
  </AppContainer>
);
